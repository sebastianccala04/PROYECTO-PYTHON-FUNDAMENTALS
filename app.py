...
if pagina == "Home":
    ...
    ruta_imagen = "imagenesportada.png"
...
# ============================================================
    ...
    if len(arrays["nombre"]) > 0:
        ...
        df_productos["Precio"] = (
            df_productos["Precio"].round(2)
        )

        df_productos["Total"] = (
            df_productos["Total"].round(2)
        )
        ...
        if st.button(
            ...
            for clave, dtype in [
                ...
                st.session_state.productos_np[clave] = (
...
# ============================================================
    ...
    st.markdown(
        ...
        La función permite calcular la depreciación anual y mensual
        de un activo.
        """
    )
...
# ============================================================
    ...
    st.title(
        "🏷️ Ejercicio 4 – Clase externa con CRUD"
    )
